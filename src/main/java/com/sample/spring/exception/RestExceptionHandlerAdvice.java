...
public class RestExceptionHandlerAdvice {
    ...
    public ResponseEntity<Object> responseException(HttpClientErrorException ex) {
        log.error("HttpClientErrorException {}", ex.getMessage(), ex);
        return new ResponseEntity<>(new ResponseVOBuilder<>().error(new ResponseErrorVo(BizErrorCode.E0004.getValue(), BizErrorCode.E0004.getDescription(), new ObjectMapper().readValue(ex.getResponseBodyAsString(), new TypeReference<>() {
